...
if(isset($_GET['id'])) {
    ...
    if(!$row) {
        echo "<script>
                ...
                window.location.href = '3rdFloor.php';
              </script>";
        exit();
    }
} else {
...
<head>
    ...
    <title>Edit 3rd_floor Report</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    <div class="container mt-5">
        <h2>Edit 3rd Floor Report</h2>
        <?php if($row): ?>
        <form method="POST">
            ...
            <input type="hidden" name="floor" value="3rd_floor">

            <div class="mb-3">
                <button type="submit" name="update" class="btn btn-primary">Update Report</button>
                <a href="3rdFloor.php" class="btn btn-secondary">Cancel</a>
            </div>
        </form>
        <?php endif; ?>
    </div>
