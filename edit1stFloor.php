...
if(isset($_GET['id'])) {
    ...
    if(!$row) {
        echo "<script>
                ...
                window.location.href = '1stFloor.php';
              </script>";
        exit();
    }
} else {
...
<head>
    ...
    <title>Edit 1st Floor Report</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    <div class="container mt-5">
        <h2>Edit 1st Floor Report</h2>
        <?php if($row): ?>
        <form method="POST">
            ...
            <input type="hidden" name="floor" value="1stFloor">

            <div class="mb-3">
                <button type="submit" name="update" class="btn btn-primary">Update Report</button>
                <a href="1stFloor.php" class="btn btn-secondary">Cancel</a>
            </div>
        </form>
        <?php endif; ?>
    </div>
