...
$query = "SELECT * FROM classroom_inspection WHERE area LIKE 'L-%'";
            ...
            <div class="col-md-10 content my-5 p-5">
                ...
                <div class="table-responsive ">
                        ...
                        <tbody>
                            ...
                            foreach ($records as $record): ?>
                                <tr>
                                    ...
                                    <td>
                                        <form action="editLowerRoom.php" method="GET"><input type="hidden" name="id" value="<?= $record['id'] ?>"><button type="submit" class="btn btn-primary">Edit</button">
                                        </form>
                                    </td>
                    ...
                    <div class="btn-container d-flex justify-content-end">
                        <a href="addLowerRoom.php"> <button class="btn btn-primary"> Add Report</button></a>
                    </div>
                </div>
            </div>
        </div>
