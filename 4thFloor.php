...
$query = "SELECT * FROM electrical_room_inspection WHERE floor LIKE '4th_floor'";
        ...
        <div class="row">
            ...
            <div class="col-md-10 content my-5 p-5">
                        ...
                        <tbody class="text-center">
                            ...
                            foreach ($records as $record): ?>
                                <tr>
                                    ...
                                    <td>
                                    <form action="edit4thFloor.php" method="GET"><input type="hidden" name="id" value="<?= $record['id'] ?>"><button type="submit" class="btn btn-primary">Edit</button">
                                    </form>
                                    </td>
                ...
                <div class="btn-container d-flex justify-content-end">
                    <a href="add4thFloor.php"> <button class="btn btn-primary"> Add Report</button></a>
                </div>
            </div>
        </div>
    </div>
