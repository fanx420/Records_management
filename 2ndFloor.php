...
$query = "SELECT * FROM electrical_room_inspection WHERE floor LIKE '2nd_floor'";
            ...
            <div class="col-md-10 content my-5 p-5">
                ...
                <div class="table-responsive ">
                        ...
                        <tbody class="text-center">
                            ...
                            foreach ($records as $record): ?>
                                <tr>
                                    ...
                                    <td>
                                        <form action="edit2ndFloor.php" method="GET"><input type="hidden" name="id" value="<?= $record['id'] ?>"><button type="submit" class="btn btn-primary">Edit</button">
                                        </form>
                                    </td>
                    ...
                    <div class="btn-container d-flex justify-content-end">
                        <a href="add2ndFloor.php"> <button class="btn btn-primary"> Add Report</button></a>
                    </div>
                </div>
            </div>
        </div>
