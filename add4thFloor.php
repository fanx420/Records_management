    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10 content my-5 p-5">
                <h2>Add 4th Floor Report</h2>
                <form action="addReport4thFloor.php" method="POST">
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                             $areas = ['Middle School', 'Upper School', 'IT', 'S.F'];
                             $transformers = ['37.5 kVA, 480V-240V', '25 kVA, 480V-240V', '', ''];
                             ...
                             for ($i = 0; $i < count($areas); $i++) {
                                 ...
                                 echo '<input type="hidden" name="floor[]" value="4th_floor">';
                                 echo '</tr>';
                             }
                            ?>
